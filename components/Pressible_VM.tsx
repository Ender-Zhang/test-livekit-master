 ...
 * @LastEditTime: 2023-05-21 08:52:07
...
function Pressible({task_id, task_date, task_status, type, navigation, destination="Survey", uncompleted, practiceSet, task_name}: any) {
    return <Box alignItems="center">
        ...
        if (type == "Meeting") {
          ...
          // console.log("1111");
          navigation.navigate("VideoMeetingPage", { pageName:"VM_ConfigScreen",type:"pre", task_id:task_id, uncompleted:uncompleted, practiceSet:practiceSet, task_name:task_name})
      }
    }
