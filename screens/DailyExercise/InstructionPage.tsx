...
function InstructionPage({ type, route, navigation } : any) {
  ...
  const styles = StyleSheet.create({
    ...
    return (
        <NativeBaseProvider>
            <Text fontSize="4xl" bold>{task_name} Instructions</Text>
            ...
            <Button onPress={() => navigation.navigate('PracticeRunningPage', { task_id: task_id, uncompleted: uncompleted, practiceSet:practiceSet, task_name: task_name })}>Start Exercise</Button>
        </NativeBaseProvider>
      );
}
