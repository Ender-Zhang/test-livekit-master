 ...
 * @LastEditTime: 2023-08-06 23:22:46
...
import BleList from './BlePages/BleList';
...
export default function MainScreen({ route, navigation } : any) {
  ...
  >
        ...
        <Tab.Screen name="Test" component={BleList} options={{ headerShown: false }} />
      </Tab.Navigator>
    </View>
  );
